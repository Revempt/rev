...
const languageData = {
    pt: {
        ...
        records: {
            ...
            items: [
                "Eu tenho mais de 3000 horas jogadas de Fortnite.",
                "Meu primeiro console foi um Xbox One",
                "Prefiro jogos com narrativas profundas e que me toquem emocionalmente",
                "Gosto e Rock e Metal",
                "Às vezes escuto a mesma música por dias sem parar",
                "Tenho vontade de aprender a tocar algum instrumento musical",
                "Makima is listening",
                "Meu jogo favorito é The Witcher 3",
                "É difícil pra mim definir uma música favorita, mas uma que sempre escuto é 'Castle of Glass'",
                "Gosto de ler mangás",
                "Também gosto de Harry Potter, Hobbit e Senhor dos Anéis",
                "Astronomia é uma das áreas mais interessantes da ciência",
    ...
    en: {
        ...
        records: {
            ...
            items: [
                ...
                "It's hard for me to define a favorite song, but one I always come back to is 'Castle of Glass'",
                "I enjoy reading manga",
                "I'm also into Harry Potter, The Hobbit, and The Lord of the Rings",
                "Astronomy is one of the most interesting areas of science.",
                "The past does not define me.",
                "I decide my own path.",
                "Sometimes, one must destroy to create something new.",
                "Sometimes, we're sure we're right, and we still fail..",
    ...
    es: {
        ...
        records: {
            ...
            items: [
                ...
                "Me gusta el rock y el metal",
                "A veces escucho la misma canción durante días",
                "Tengo ganas de aprender a tocar algún instrumento musical",
                "Makima está escuchando",
                "Mi juego favorito es The Witcher 3",
                "Me cuesta definir una canción favorita, pero una que siempre escucho es 'Castle of Glass'",
                "Me gusta leer manga",
                "También me gustan Harry Potter, El Hobbit y El Señor de los Anillos",
                "La astronomía es una de las áreas más interesantes de la ciencia.",
    ...
    ja: {
        ...
        records: {
            ...
            items: [
                ...
                "マキマは聞いている。",
                "一番好きなゲームはThe Witcher 3です。",
                "好きな曲を一つに決めるのは難しいですが、'Castle of Glass'はよく聴きます。",
                "漫画を読むのが好きです。",
                "ハリー・ポッター、ホビット、指輪物語も好きです。",
                "天文学は科学の中で最も興味深い分野の一つです。",
                "過去は私を定義しない。",
                "自分の道は自分で決める。",
