    ...
    pt: {
        ...
        records: {
            ...
            items: [
                ...
                "Meu sonho é ter uma amada placa de vídeo",
    ...
    en: {
        ...
        records: {
            ...
            items: [
                ...
                "My dream is to own a decent, beloved graphics card",
                "The past does not define me.",
                "I decide my own path.",
                "Sometimes, one must destroy to create something new.",
                "Sometimes, we're sure we're right, and we still fail..",
    ...
    es: {
        ...
        records: {
            ...
            items: [
                ...
                "Mi sueño es tener una querida y decente tarjeta gráfica",
